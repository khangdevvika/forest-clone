  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ type: "spring", stiffness: 320, damping: 35, mass: 1 }}
      ...
      <motion.div
        ...
        animate={{
          ...
          opacity: state === "collapsed" && collapsible === "offcanvas" ? 0 : 1,
          width: state === "collapsed" && collapsible === "icon" ? (variant === "floating" || variant === "inset" ? "4.5rem" : "3rem") : SIDEBAR_WIDTH,
        }}
        transition={{ type: "spring", stiffness: 320, damping: 35, mass: 1 }}
        className={cn(
